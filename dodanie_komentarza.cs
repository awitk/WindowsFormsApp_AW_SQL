...
{
    public partial class dodanie_komentarza : Form
    {
        private const string ConnectionString = "Data Source=DESKTOP-D50UGU8\SQL_AW;Initial Catalog=master;Integrated Security=True";

        public dodanie_komentarza()
        {
            InitializeComponent();
        }
